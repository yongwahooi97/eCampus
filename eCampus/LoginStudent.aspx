<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginStudent.aspx.cs" Inherits="eCampus.LoginStudent" %>
    ...
    <form id="form1" runat="server">
        <div id="background">
            <div id="content">
                ...
                <h1>TARUC Student eCampus</h1>
                <h3>Please Enter Your Information:</h3>
                <div id="id_icon">
                    <asp:TextBox ID="id" placeholder="STUDENT ID" CssClass="id" runat="server" MaxLength="15"></asp:TextBox>
                </div>
